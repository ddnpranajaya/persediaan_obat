...
<html>
  <head>
    ...
    <meta name="description" content="Sistem Informasi Gudang Obat">
    <meta name="author" content="Deden Yudha Pranajaya" />

    <!-- favicon -->
    <link rel="shortcut icon" href="assets/img/logo-clk.png" />
  ...
  <body class="login-page bg-login">
    <div class="login-box">
      <div style="color:#000000" class="login-logo">
        <img style="margin-top:-12px" src="assets/img/logo-clk.png" alt="Logo" height="50">
        <br><b>Sistem Informasi Gudang Obat</b>
        <br><b>Puskesmas Cicalengka DTP</b>
      </div><!-- /.login-logo -->
      <?php  
