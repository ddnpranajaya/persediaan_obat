...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Admin Panel | Sistem Informasi Gudang Obat</title>
    <meta content='width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no' name='viewport'>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <meta name="description" content="Sisyem Informasi Gudang Obat">
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="?module=beranda" class="logo">
          ...
          <span style="font-size:30px">Farmasi</span>
        </a>
      ...
      <footer class="main-footer">
        <strong>Copyright &copy; 2024 - <a href="https://masoemuniversity.ac.id">Ma'soem University</a>.</strong>
      </footer>
    </div><!-- ./wrapper -->
